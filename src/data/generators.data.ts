...
export const GENERATORS: GeneratorDef[] = [
  ...
  },
  {
    ...
    description: 'Défriche et cultive : relève le plafond nourricier (Vivres produites).',
    produces: {},
    baseCost: { food: new Decimal(300) },
    costGrowth: 1.22,
    discover: { kind: 'resource', resource: 'population', atLeast: new Decimal(60) },
    effects: [{ kind: 'raiseFoodCeiling', amount: 8 }],
  },
  {
    id: 'woodfire',
    tier: 0,
  ...
  },
  {
    ...
    baseCost: { food: new Decimal(120) },
    costGrowth: 1.2,
    discover: { kind: 'resource', resource: 'population', atLeast: new Decimal(80) },
  },
  {
    id: 'watermill',
    tier: 0,
